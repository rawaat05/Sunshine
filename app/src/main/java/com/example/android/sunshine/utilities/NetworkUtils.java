...
public final class NetworkUtils {
    ...
    private static final String ID = "&APPID=76e711b1b9382ca759d8c8f76ac10f14";

    private static final String STATIC_WEATHER_URL =
            "http://api.openweathermap.org/data/2.5/forecast?id=524901&APPID=76e711b1b9382ca759d8c8f76ac10f14";
    ...
    private static URL buildUrlWithLatitudeLongitude(Double latitude, Double longitude) {
        Uri weatherQueryUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                ...
                .appendPath(ID)
                .build();
        // TODO: connect and try if works, if not, see URI and make changes in JSON?

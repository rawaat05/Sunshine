 ...
 */
package com.nomaa.sunshine.utilities;

import android.content.Context;
import android.net.Uri;
import android.util.Log;

import com.nomaa.sunshine.BuildConfig;
import com.nomaa.sunshine.data.SunshinePreferences;
import com.nomaa.sunshine.data.WeatherContract;
import com.nomaa.sunshine.data.WeatherDbHelper;
...
public final class NetworkUtils {
    ...
    private static final String ID = "&APPID=" + BuildConfig.ApiKey + "&cnt=7&units=metric";
    ...
    public static URL getUrl(Context context) {
        ...
        Log.e(TAG, "Now erasing table");
        new WeatherDbHelper(context).getWritableDatabase().delete(WeatherContract.WeatherEntry.TABLE_NAME,null , null);
...
//        } else {
        ...
        if(locationQuery.trim().length() == 5)
...
//
    ...
    private static URL buildUrlWithLatitudeLongitude(Context context, Double latitude, Double longitude) {
        ...
        String uri = FORECAST_BASE_URL + "lat={" + latitude + "}&lon={" + longitude + "}" + ID;
    ...
    private static URL buildUrlWithLocationQuery(String locationQuery) {
        ...
        Uri weatherQueryUri = null;

        String url = STATIC_WEATHER_URL + "zip=" + locationQuery.trim() + ID;
        weatherQueryUri = Uri.parse(url).buildUpon().build();
